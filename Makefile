...
# translation
SOURCES = \
	cartography_tools/__init__.py

PLUGIN_NAME = cartography_tools
...
test: transcompile
	...
	@-export PYTHONPATH=`pwd`:$(PYTHONPATH); \
		...
		nosetests3 -v -s --with-id --with-coverage --cover-package=. cartography_tools.test \
		3>&1 1>&2 2>&3 3>&- || true
	@echo "----------------------"
...
pylint:
	...
	@echo "-----------------"
	@pylint --reports=n --rcfile=pylintrc cartography_tools
	@echo
	@echo "----------------------"
	@echo "If you get a 'no module named qgis.core' error, try sourcing"
...
pycodestyle:
	...
	@echo "-----------"
	@pycodestyle --repeat --ignore=E203,E121,E122,E123,E124,E125,E126,E127,E128,E402,E501,W504 --exclude $(PEP8EXCLUDE) cartography_tools
	@echo "-----------"
